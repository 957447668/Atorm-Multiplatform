...
import com.zxhhyj.atorm.openai.api.core.Endpoint
...
public data class BatchRequest(
    ...
    /**
     * The endpoint to be used for all requests in the batch. Currently only [Endpoint.Companion.Completions] is supported.
     */
