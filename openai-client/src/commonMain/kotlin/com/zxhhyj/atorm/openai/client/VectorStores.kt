...
public interface VectorStores {
     ...
     * For instance, if you make a list request and receive 100 objects, ending with obj_foo, your later call can
     * include before=obj_foo to fetch the previous page of the list.
     * @param filter Filter by file status. One of [com.zxhhyj.atorm.openai.api.core.Status.Companion.InProgress], [com.zxhhyj.atorm.openai.api.core.Status.Companion.Completed], [com.zxhhyj.atorm.openai.api.core.Status.Companion.Failed],
     * [com.zxhhyj.atorm.openai.api.core.Status.Companion.Cancelled].
     * @param requestOptions request options.
     */
