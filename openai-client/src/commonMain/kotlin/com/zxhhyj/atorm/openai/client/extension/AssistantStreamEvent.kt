...
/**
 * Get the data of the [com.zxhhyj.atorm.openai.api.run.AssistantStreamEvent] using the provided [serializer] from the corresponding event type.
 * @param <T> the type of the data.
 * @throws IllegalStateException if the [com.zxhhyj.atorm.openai.api.run.AssistantStreamEvent] data is null.
 * @throws ClassCastException if the [com.zxhhyj.atorm.openai.api.run.AssistantStreamEvent] data cannot be cast to the provided type.
 */
...
/**
 * Get the data of the [com.zxhhyj.atorm.openai.api.run.AssistantStreamEvent] using the provided [serializer].
 * @throws IllegalStateException if the [com.zxhhyj.atorm.openai.api.run.AssistantStreamEvent] data is null.
 * @throws ClassCastException if the [com.zxhhyj.atorm.openai.api.run.AssistantStreamEvent] data cannot be cast to the provided type.
 */
