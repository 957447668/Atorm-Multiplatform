...
public sealed interface RunStep {
    ...
    /**
     * The status of the run step, which can be either [Status.Companion.InProgress], [Status.Companion.Cancelled], [Status.Companion.Failed],
     * [Status.Companion.Completed], or [Status.Companion.Expired].
     */
    ...
    /**
     * The Unix timestamp (in seconds) for when the run step was [Status.Companion.Cancelled].
     */
