package com.zxhhyj.atorm.openai.api.core
...
public data class Parameters(public val schema: JsonElement) {
    ...
    public companion object {
        ...
        /**
         * Creates a [Parameters] instance using a [kotlinx.serialization.json.JsonObjectBuilder].
         *
         * @param block The [kotlinx.serialization.json.JsonObjectBuilder] to use.
         */
