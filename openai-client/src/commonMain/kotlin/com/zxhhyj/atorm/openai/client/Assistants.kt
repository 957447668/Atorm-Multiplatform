...
public interface Assistants {
     ...
     * @param order sort order by the `createdAt` timestamp of the objects. [com.zxhhyj.atorm.openai.api.core.SortOrder.Companion.Ascending] for ascending order
     * and [com.zxhhyj.atorm.openai.api.core.SortOrder.Companion.Descending] for descending order.
