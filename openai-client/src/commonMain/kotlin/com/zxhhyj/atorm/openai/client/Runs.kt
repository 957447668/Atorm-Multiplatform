...
public interface Runs {
    ...
    /**
     * When a run has the status: [com.zxhhyj.atorm.openai.api.core.Status.Companion.RequiresAction] and required action is [com.zxhhyj.atorm.openai.api.run.RequiredAction.SubmitToolOutputs],
    ...
    /**
     * Cancels a run that is [com.zxhhyj.atorm.openai.api.core.Status.Companion.InProgress].
     *
     * @param threadId the ID of the thread to which this run belongs
