...
import com.zxhhyj.atorm.openai.api.assistant.AssistantTool
import com.zxhhyj.atorm.openai.api.core.LastError
...
public data class Run(
    ...
    /**
     * The status of the run, which can be either [Status.Companion.Queued], [Status.Companion.InProgress], [Status.Companion.RequiresAction],
     * [Status.Companion.Cancelling], [Status.Companion.Cancelled], [Status.Companion.Failed], [Status.Companion.Completed], or [Status.Companion.Expired].
     */
