...
public class ToolBuilder {
    ...
    public fun function(name: String, description: String? = null, parameters: String) {
        functions += Tool.function(name, description, Parameters.Companion.fromJsonString(parameters))
    }
    ...
    public fun function(name: String, description: String? = null, parameters: JsonObjectBuilder.() -> Unit) {
        functions += Tool.function(name, description, Parameters.Companion.buildJsonObject(parameters))
    }
}
