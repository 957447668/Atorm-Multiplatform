...
import com.zxhhyj.atorm.openai.api.core.FinishReason
...
public data class Choice(
    ...
    /**
     * The reason the model stopped generating tokens. This will be [FinishReason.Companion.Stop] if the model hit a natural stop
     * point or a provided stop sequence, or [FinishReason.Companion.Length] if the maximum number of tokens specified in the
     * request was reached.
     */
