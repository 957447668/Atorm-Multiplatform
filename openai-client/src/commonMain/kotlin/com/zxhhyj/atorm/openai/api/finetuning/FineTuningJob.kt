package com.zxhhyj.atorm.openai.api.finetuning

import com.zxhhyj.atorm.openai.api.core.OrganizationId
...
public data class FineTuningJob(
    ...
    /**
     * The current status of the fine-tuning job (e.g., [Status.Companion.ValidatingFiles], [Status.Companion.Queued], etc.).
     */
    @SerialName("status")
    val status: Status,
